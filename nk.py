...
# https://github.com/demisjohn/nk.py
...
Demis D. John:  2009 added some Cauchy fits for SiO2, Ta2O5, SiN
                ...
                2025: Added IBD Films Ta2O5, TiO2, Al2O3
...
''' Cauchy model with birefringent offset
   A + B/lambda^2 + C   '''
...
def IBD_Ta2O5_DJ2018 ( wl ):
	'''Ion Beam Sputter Deposited Ta2O5, UCSB Nanofab ~2018
	https://wiki.nanofab.ucsb.edu/wiki/Sputtering_Recipes#Ta2O5_deposition_(IBD)
    ...
    check_wl(wl, 0.350, 2.00, 'IBD_TiO2_DJ2018')
    return cauchy(  (2.1123, 0.018901, -0.016222 ), wl  )
#end def(IBD_Ta2O5)




def IBD_TiO2_DJ2018 ( wl ):
	'''Ion Beam Sputter Deposited TiO2, UCSB Nanofab ~2018
	https://wiki.nanofab.ucsb.edu/wiki/Sputtering_Recipes#TiO2_deposition_(IBD)
    ...
    check_wl(wl, 0.350, 2.00, 'IBD_TiO2_DJ2018')
    return cauchy(  (2.435, -4.9045e-4, 0.01309 ), wl  )
#end def(IBD_Ta2O5)



def IBD_Al2O3_DJ2018 ( wl ):
	'''Ion Beam Sputter Deposited Al2O3, UCSB Nanofab ~2018
	https://wiki.nanofab.ucsb.edu/wiki/Sputtering_Recipes#TiO2_deposition_(IBD)
...
##  Film aliases  ##
####################
# Some aliases are defined above, near the definition they alias to.

SiO2 = JAW_ThermalSiO2
SiO = SiO2

Si3N4 = PECVD_SiN
SiN = Si3N4

Ta2O5 = IBD_Ta2O5_DJ2018       # Alias
TaO = Ta2O5                    # Alias

TiO2 = IBD_TiO2_DJ2018      # Alias
TiO = TiO2                  # Alias

Al2O3 = IBD_Al2O3_DJ2018        # Alias
AlO = Al2O3                     # Alias
